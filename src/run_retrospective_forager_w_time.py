...
class retrospective_time_forager(nn.Module):
    def __init__(
        self,
        n_features: int,
        n_actions: int,
        ...
        super(retrospective_time_forager, self).__init__()
...
def main(session_duration,
    ...
    for n_rep in tqdm(range(n_reps)):
        # init the agent
        agent = retrospective_time_forager(obs_shape, 
                                              action_shape, 
                                              device, 
                                              critic_lr, 
                                              actor_lr,  
    ...
    with open(f'results/PAFM/retrospective_forager_w_time.pkl', 'wb') as f:
